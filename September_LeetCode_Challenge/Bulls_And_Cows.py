...
and position (called "bulls") and how many digits match the secret number but locate 
in the wrong position (called "cows"). Your friend will use successive guesses 
...
friend-s guess only contain digits, and their lengths are always equal.
...
class Solution:
    def getHint(self, secret: str, guess: str) -> str:
        ...
        for i, char in enumerate(guess):
            ...
            if char != secret[i] and char in mappings and mappings[char]>0:
                B += 1
                mappings[char] -= 1
